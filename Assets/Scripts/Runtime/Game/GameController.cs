...
namespace Unity.Template.Multiplayer.NGO.Runtime
{
    ...
    public class GameController : Controller<GameApplication>
    {
        ...
        {
            UnityEngine.Debug.Log($"[Server] Client with it {evt.ClientId} disconnected!");
        ...
        void OnServerStartMatch(StartMatchEvent evt)
        {
            if (evt.IsServer)
            {
                UnityEngine.Debug.Log("[Server] Starting match!");
            ...
            if (evt.IsClient)
            {
                UnityEngine.Debug.Log("[Client] Starting match!");
            }
        }
